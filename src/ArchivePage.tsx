...
const ArchivePage = () => {
  const archives = [
    { id: 2, title: '소상공인 시장진흥공단 통합사업 공고', date: '2021-10-03', files: 1 },
    { id: 1, title: '2021년도 창업지원사업 통합공고문', date: '2021-10-03', files: 1 },
  ];
  ...
  return (
    <div className="max-w-[1300px] mx-auto px-4 py-12 md:py-20">
      <motion.div 
        ...
        className="mb-16"
      >
        <h2 className="text-4xl font-bold mb-6 tracking-tight">자료실</h2>
        <p className="text-lg text-gray-600 leading-relaxed max-w-4xl">
          R&D 지원사업 및 창업지원사업 관련 유용한 자료들을 모아놓은 공간입니다.
        </p>
      </motion.div>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <button className="w-10 h-10 flex items-center justify-center bg-blue-600 text-white rounded-lg font-bold">1</button>
        </div>
      </div>
    </div>
  );
